...
QT_MOC_LITERAL(3, 25, 7), // "printer"
QT_MOC_LITERAL(4, 33, 4) // "name"

    },
    "DataManager\0nameChanged\0\0printer\0name"
};
...
void DataManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::nameChanged)) {
                *result = 0;
                return;
            }
        }
