...
Qt3DRender::QGeometryRenderer *DDDUtils::createWireframePlaneMesh(int lineCount)
{
...
void DDDUtils::addPositionAttributeToGeometry(Qt3DRender::QGeometry *geometry, Qt3DRender::QBuffer *buffer, int count)
{
